        ...
        {result && (
          <div className="mt-6 p-4 rounded-lg bg-gray-50 border border-gray-200">
            ...
            <ul className="space-y-1 text-gray-800">
              <li><span className="font-semibold">Score:</span> {result.score}</li>
              <li><span className="font-semibold">Confidence:</span> {result.confidence}</li>
              <li><span className="font-semibold">Sentiment:</span> {result.sentiment}</li>
            </ul>
          </div>
        )}
      </div>
